...
export const dictionary = [
    ['break', 'обосрисьмнетут'],
    ['case', 'аеслижопутвоювысру'],
    ['case', 'аеслижопутвоювысру'],
    ['catch', 'всрать'],
    ['catch', 'аченесрет'],
    ['catch', 'аченесрет'],
    ['catch', 'ачёнесрет'],
    ['continue', 'пердидальшеокунь'],
    ['debugger', 'анализкала'],
    ['delete', 'высратьобратно'],
    ['delete', 'изфекалитьдо'],
    ['do', 'поносить'],
    ['else', 'тогдапердим'],
    ['finally', 'усеобосрато'],
    ...
    ['if', 'еслипосрем'],
    ['in', 'чоунассрут'],
    ['default', 'дебильноеговнодебильногоговна'],
    ['default', 'апохуй'],
    ['default', 'наотыбись'],
    ['instanceof', 'шкура'],
    ['new', 'гыйбать'],
    ...
    ['false', 'вГовне'],
      ['eval', 'говноВговне'],
    // ['\'use strict\'', '\'далиШептуна\''], Баг: global.yopta("'use strict'", 'js') возвращает 'use strict'
    ...
    ['module', 'братва'],
    ['exports', 'хапайноздрямиродной'],
    ['export', 'хапайноздрями'],
    ['global', 'полныйобосрамс'],
